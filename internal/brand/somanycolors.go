...
// https://github.com/jeff3754/HexColorToColorName/blob/master/src/internal/color-names.ts
// Thanks to the author for providing the color names mapping. The original source can be found at the above link.
var colorNamesMap = map[string]string{
	"000000": "Black",
	"000080": "Navy Blue",
	"0000C8": "Dark Blue",
	"0000FF": "Blue",
