...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "flex h-12 items-center rounded-base border-2 border-border bg-background p-1 text-foreground overflow-x-auto",
        className,
      )}
